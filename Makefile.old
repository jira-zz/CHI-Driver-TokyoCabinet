# This Makefile is for the CHI::Driver::TokyoCabinet extension to perl.
#
...
#     EXE_FILES => []
#     INSTALLDIRS => q[site]
#     NAME => q[CHI::Driver::TokyoCabinet]
#     PL_FILES => {  }
#     PREREQ_PM => { TokyoCabinet=>q[0], Test::More=>q[0], Test::Class=>q[0], CHI=>q[0] }
#     VERSION_FROM => q[lib/CHI/Driver/TokyoCabinet.pm]
...
NAME_SYM = CHI_Driver_TokyoCabinet
VERSION = 0.0.1
...
MAKE = make
FULLEXT = CHI/Driver/TokyoCabinet
BASEEXT = TokyoCabinet
PARENT_NAME = CHI::Driver
DLBASE = $(BASEEXT)
VERSION_FROM = lib/CHI/Driver/TokyoCabinet.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/CHI/Driver/TokyoCabinet.pm \
	lib/CHI/Driver/TokyoCabinet.pm.bck \
	lib/CHI/Driver/bla \
	lib/CHI/t/Driver/TokyoCabinet.pm

PM_TO_BLIB = lib/CHI/Driver/TokyoCabinet.pm.bck \
	blib/lib/CHI/Driver/TokyoCabinet.pm.bck \
	lib/CHI/Driver/TokyoCabinet.pm \
	blib/lib/CHI/Driver/TokyoCabinet.pm \
	lib/CHI/t/Driver/TokyoCabinet.pm \
	blib/lib/CHI/t/Driver/TokyoCabinet.pm \
	lib/CHI/Driver/bla \
	blib/lib/CHI/Driver/bla
...
DISTNAME = CHI-Driver-TokyoCabinet
DISTVNAME = CHI-Driver-TokyoCabinet-0.0.1
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               CHI-Driver-TokyoCabinet' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    CHI:           0' >> META_new.yml
	$(NOECHO) $(ECHO) '    Test::Class:   0' >> META_new.yml
	$(NOECHO) $(ECHO) '    Test::More:    0' >> META_new.yml
	$(NOECHO) $(ECHO) '    TokyoCabinet:  0' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="CHI::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Test::Class" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Test::More" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="TokyoCabinet::" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/CHI/Driver/TokyoCabinet.pm.bck blib/lib/CHI/Driver/TokyoCabinet.pm.bck \
	  lib/CHI/Driver/TokyoCabinet.pm blib/lib/CHI/Driver/TokyoCabinet.pm \
	  lib/CHI/t/Driver/TokyoCabinet.pm blib/lib/CHI/t/Driver/TokyoCabinet.pm \
	  lib/CHI/Driver/bla blib/lib/CHI/Driver/bla 
